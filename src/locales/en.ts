export default {
  translation: {
    ...
    getRidOfUnimportant:
      "Don't be afraid to get rid of unimportant tasks.",
    feedback: 'Feedback',
  ...
  FAQ: {
    ...
    'The app helps you do things that you always put off.': 'The app helps you do things that you always put off.',
    'What tasks does it help to overcome?': 'What tasks does it help to overcome?',
    ...
    'How is this app different from others?': 'How is this app different from others?',
