export default {
  ...
  FAQ: {
    'What is this app for?': 'Что это за приложение?',
    'The app helps you do things that you always put off.': 'Оно помогает выполнять дела, которые ты вечно откладываешь.',
    'What tasks does it help to overcome?': 'Какие задачи решает приложение?',
    'Tasks that are not important and are constantly postponed': 'Задачи которые не особо важны и которые вечно откладываешь в долгий ящик.'
    ...
    'How is this app different from others?': 'Чем это приложение лучше других? Чем оно особенно?',
    'The app uses psychologic tricks to motivate us': 'Эта программа использует различные психологические техники чтобы мотивировать вас, облегчить задачи и помочь сдвинуться с места.'
      + ' Она будет словно вести вас под руку при выполнении задач, по пути подсказывая решения типичных проблем.',
    'Where are all my tasks?': 'Где все мои задачи?',
    'The app hides tasks list from you.': 'Приложение намеренно скрывает от вас список всех задач. Это часть дизайна.'
    ...
    'Where do my taksk disappear?': 'Куда пропадают мои задачи?',
    'After you worked on a task it will be postponed': 'После того как вы поработали над задачей, она будет отложена. Программа использует увеличивающиеся интервальные повторения чтобы расчитать когда вам будет наиболее комфортно вернуться к задаче вновь.',
  }
};
