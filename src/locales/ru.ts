export default {
  translation: {
    ...
    this_app_will_allow_help_you_with_tasks:
      ...
      simply_add_few_tasks_and_watch: 'Просто добавь пару задач и смотри, как приложение с помощью психологических трюков облегчает их и позволяет сдвинуться с мертвой точки.',
    },
  sidebar: {
