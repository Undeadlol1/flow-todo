...
const data = [
  ...
  [
    ...
    'Аноним - анонимный пользователь. По-умолчанию все пользователи анонимны. Это позволяет вам пользоваться приложением без регистрации. ВНИМАНИЕ: если вы не зарегистрируетесь то в буущем ваши данные будут потеряны.',
  ],
];
